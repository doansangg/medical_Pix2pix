...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--label_image', type=str, default='path_data/input.txt', help='input path')
        self.parser.add_argument('--real_image', type=str, default='path_data/real_ouput.txt', help='path output')
        # input/output sizes       
        self.parser.add_argument('--batchSize', type=int, default=3, help='input batch size')
        self.parser.add_argument('--loadSize', type=int, default=352, help='scale images to this size')
